...
| 2 | [Mouse Eraser](#2ο-παραδοτέο---mouse-eraser) |
...
Για το δεύτερο παραδοτέο επέλεξα την προγραμματιστική άσκηση ‘’Mouse Eraser’’ στην οποία μετατρέπουμε τον κέρσορα του ποντικιού μας σε ένα εικονικό ‘’σβηστήρι’’. Στόχος της άσκησης ήταν να αλλάξουμε τις εικόνες που χρησιμοποιούνταν ήδη και να αλλάξουμε και το μέγεθος της εικονικής "σβήστρας".
...
Link του fork του αποθετηρίου pibook για το embed της άσκησης: [_remix/mouse-eraser](https://github.com/KuhakuNeko/site/blob/master/_remix/mouse-eraser.md)

Link στο pen της άσκησης στο codepen.io: [MouseEraser P2019108](https://codepen.io/P2019108/pen/XWKdXLK)

Το αποτέλεσμα της άσκησης είναι ωραίο, διαδραστικό και χρήσιμο, θα μπορούσε να χρησιμοποιηθεί σε μια διαδικτυακή σελίδα ή ακόμα με πολύ βελτίωση θα μπορούσε να γίνει ένα μικρό παιχνίδι. 
